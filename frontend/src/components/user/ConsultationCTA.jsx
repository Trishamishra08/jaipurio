      ...
      <div className="bg-[#054425] rounded-2xl p-5 md:p-6 text-center relative overflow-hidden group max-w-lg mx-auto shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-500">
        ...
        <div className="relative z-10 mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2.5">
            ...
            <a 
              href={getWhatsAppHref('Hello Jaipurio, I have an inquiry regarding your products.')}
              onClick={handleWhatsAppClick('Hello Jaipurio, I have an inquiry regarding your products.')}
              target="_blank"
              rel="noreferrer"
